...
- Discourse/Glimmer/admin frontend -> `assets/javascripts/discourse/AGENTS.md`
...
Reusable task procedures live under `.agents/skills/`; read only the matching `SKILL.md`.
